        ...
        <div className="max-w-3xl mx-auto">
          ...
          <section className="bg-[#111827] rounded-xl p-6 mb-6">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-lg bg-gray-700 flex items-center justify-center text-gray-400 font-semibold">
                JD
              </div>
              <div>
                <h2 className="font-medium">Abdulaziz Isa</h2>
                <p className="text-sm text-gray-400">abdulaziz.isa@gmail.com</p>
              </div>
            </div>
          ...
          <section className="bg-[#111827] rounded-xl p-6 mb-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <button
                  className={`w-12 h-6 rounded-full p-1 transition-colors ${
                    allMotionAlerts ? "bg-[#00a3ff]" : "bg-gray-700"
                  }`}
                  onClick={() => setAllMotionAlerts(!allMotionAlerts)}
                >
                  <div
                    className={`w-4 h-4 rounded-full bg-white transform transition-transform ${
                      allMotionAlerts ? "translate-x-6" : "translate-x-0"
                    }`}
                  ></div>
                </button>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <button
                  className={`w-12 h-6 rounded-full p-1 transition-colors ${
                    timeBasedAlerts ? "bg-[#00a3ff]" : "bg-gray-700"
                  }`}
                  onClick={() => setTimeBasedAlerts(!timeBasedAlerts)}
                >
                  <div
                    className={`w-4 h-4 rounded-full bg-white transform transition-transform ${
                      timeBasedAlerts ? "translate-x-6" : "translate-x-0"
                    }`}
                  ></div>
                </button>
              </div>
              ...
              <div className="flex justify-between items-center">
                ...
                <button
                  className={`w-12 h-6 rounded-full p-1 transition-colors ${
                    soundAlerts ? "bg-[#00a3ff]" : "bg-gray-700"
                  }`}
